...
# sample text
text = open("F:\CS524\cs524-chatbot-project-refresh\cs524-chatbot-project\canvas_exercises\labs\m7_b4\m7_b4.txt", 'r').read()
...
summary_sentences = select_sentences(sentence_scores, num_sentences=5)
